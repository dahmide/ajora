                ...
                <Body className="bg-white font-sans">
                    <Container className="mx-auto py-12 px-4 max-w-xl">
                        ...
                        <Text className="text-base text-gray-700 leading-6">
                            We&apos;re thrilled to have you join us. Your
                            account is all set up and ready to go.
                        </Text>

                        <Text className="text-base text-gray-700 leading-6">
                            Click the button below to access your dashboard and
                            explore everything {APP_NAME} has to offer.
                        </Text>
                        ...
                        <Text className="text-sm text-gray-500">
                            If you didn&apos;t create an account with Acme, you
