...
interface PasswordResetEmailProps {
    /** OTP code to reset the password */
    code: string;
            ...
            <Tailwind>
                <Body className="bg-white font-sans">
                    <Container className="mx-auto py-12 px-4 max-w-xl">
                        ...
                        <Text className="bg-black text-white px-6 py-3 rounded-md font-medium mt-4 inline-block box-border">
                            {code}
                        </Text>
                        ...
                        <div className="bg-yellow-50 border border-solid border-yellow-200 rounded-md p-4 mt-6">
                            <Text className="text-sm text-yellow-800 m-0">
                                <strong>Security tip:</strong> Never share this
                                link with anyone. Acme will never ask for your
                                password via email.
                            </Text>
                        </div>
                    </Container>
...
PasswordResetEmail.PreviewProps = {
    code: "https://example.com/reset-password?token=abc123xyz",
    expiresIn: "1 hour",
